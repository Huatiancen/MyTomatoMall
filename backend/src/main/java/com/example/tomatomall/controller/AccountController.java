...
public class AccountController {
    ...
    public Response<Boolean> checkPassword(@RequestBody AccountVO accountVO) {
        return Response.buildSuccess(accountService.checkPassword(accountVO.getUsername(), accountVO.getPassword()));
    }
